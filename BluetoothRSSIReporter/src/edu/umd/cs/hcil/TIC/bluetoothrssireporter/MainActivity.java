package edu.umd.cs.hcil.TIC.bluetoothrssireporter;

import android.provider.Settings.Secure;

import com.loopj.android.http.*;

import edu.umd.cs.hcil.TIC.bluetoothrssireporter.R; 
...
public class MainActivity extends Activity {
	...
	private void sendData(String gear_id, int rssi) {
		...
		httpClient.post(getApplicationContext(), "http://nameless-bastion-3282.herokuapp.com/writeTrainData", params, new AsyncHttpResponseHandler() {
			@Override
